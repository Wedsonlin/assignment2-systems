...
from cs336_systems.flash_attention import FlashAttentionV2Pytorch, FlashAttentionV2Triton
from cs336_systems.ddp import NaiveDDP, OptimizedDDP
...
def get_flashattention_autograd_function_pytorch() -> type:
    ...
    return FlashAttentionV2Pytorch
